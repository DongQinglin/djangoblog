# Generated by Django 3.0 on 2019-12-05 15:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, verbose_name='是否activce')),
            ],
            options={
                'verbose_name': '轮播图',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(null=True, upload_to='article_img/%Y/%m/%d/', verbose_name='文章图片')),
                ('content', models.TextField()),
                ('viewscount', models.PositiveIntegerField(default=0, verbose_name='阅读量')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='发布时间')),
                ('modified_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
                ('kind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='blog.ArticleKind', verbose_name='分类')),
                ...
                ('tags', models.ManyToManyField(blank=True, to='blog.ArticleTag', verbose_name='标签')),
            ],
            options={
                'verbose_name': '文章',
